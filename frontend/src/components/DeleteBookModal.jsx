    ...
    <Modal open={open} onClose={handleClose}>
      <Box sx={getModalSurfaceSx({ xs: "calc(100% - 24px)", sm: 460 })}>
        ...
        <Box sx={{ px: { xs: 2, sm: 3 }, pt: 3, pb: 3 }}>
          <Typography
            sx={{ fontSize: "0.95rem", color: "#3d3025", lineHeight: 1.7 }}
          >
            Remove{" "}
            <Box
              component="span"
              sx={{ fontWeight: 800, color: uiTokens.color.ink }}
            >
              “{book.title}”
            </Box>{" "}
          ...
          <Typography
            sx={{ mt: 1, fontSize: "0.82rem", color: uiTokens.color.soft }}
          >
          ...
          {serverError && (
            <Typography
              sx={{ mt: 2, fontSize: "0.82rem", color: uiTokens.color.danger }}
            >
              {serverError}
            </Typography>
          )}
          ...
          >
            ...
            <Button
              ...
              sx={{
                ...
                borderRadius: "12px",
                px: 2.5,
                background: "linear-gradient(135deg, #8f3d2f 0%, #b05746 100%)",
                minWidth: 104,
              }}
            >
              {deleting ? (
